...
class ldp_vldp : public ldp
{
  ...
  public:
    ...
    void set_audio_delay(int delay_ms) { extern int g_audio_delay_ms; g_audio_delay_ms = delay_ms; }
    bool nudge_audio_delay(int delta_ms);
    int get_audio_delay_ms() const;
